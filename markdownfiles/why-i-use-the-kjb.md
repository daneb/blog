...
7. **Use of Questionable Manuscripts**: Modern versions all rely on the Aleph and B (Sinaiticus and Vaticanus).
8. **The Attack on the Deity of Christ**: Here are some of the most significant changes found in the modern versions where Christ's deity is either removed or altered. For simplicity I am just going to compare the KJB to ESV and NASB. 
